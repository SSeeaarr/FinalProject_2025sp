...
export default class OBJ_GreenDoor extends OBJ_Door {
    constructor() {
        super();
        this.name = "Green Door";
        this.type = "p";
        this.image.src = './res/objects/GreenDoor.png';
        this.requiredKey = "green";
        this.collision = true;
        this.opened = false; 
    }
    ...
    use(player) {
        if (!this.opened) {
            ...
            if (player.hasItem("Blue Key")) {
                ...
                this.gp.ui.showMessage("You need a green key to open this door!", "lock");
            }
        }
    }
}